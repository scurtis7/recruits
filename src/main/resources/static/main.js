...
function SignupComponent_div_28_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("User ", ctx_r1.username, " added successfully!\u00A0\u00A0\u00A0You can now ");
} }
class SignupComponent {
    ...
    createSiteUser() {
        ...
        const newUser = this.userService.createUser(new _model_site_user__WEBPACK_IMPORTED_MODULE_1__["SiteUser"](this.name, this.username, this.password));
        if (newUser != null) {
...
SignupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SignupComponent, selectors: [["app-signup"]], decls: 37, vars: 6, consts: [[1, "div-main-layout"], [1, "row"], [1, "col"], [1, "badge", "badge-info"], ["type", "text", "placeholder", "Name", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "placeholder", "Username", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "password", "placeholder", "Password", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "password", "placeholder", "Confirm Password", 1, "form-control", 3, "ngModel", "ngModelChange", "keyup"], ["class", "row", 4, "ngIf"], [1, "error-message"], ["type", "button", "title", "CreateAcct", 1, "btn", "btn-primary", 3, "click"], [1, "success-message"], ["type", "button", "title", "Login", "routerLink", "/signin", 1, "btn", "btn-primary-outline"]], template: function SignupComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](28, SignupComponent_div_28_Template, 6, 1, "div", 8);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SignupComponent_Template_button_click_35_listener() { return ctx.createSiteUser(); });
